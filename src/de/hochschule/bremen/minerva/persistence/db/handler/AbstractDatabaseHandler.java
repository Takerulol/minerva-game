...
public abstract class AbstractDatabaseHandler {
	 ...
	 * @throws Exception
	 */
	protected int update(String sql, Object[] params) throws DatabaseIOException {
		this.connect();
		...
		try {
			...
			statement.close();
			return this.determineAutoGeneratedId(statement);
		} catch (SQLException e) {
	 ...
	 * @throws Exception
	 */
	protected int insert(String sql, Object[] params) throws DatabaseIOException {
		this.connect();
	 ...
	 * @throws SQLException 
	 */
	private int determineAutoGeneratedId(PreparedStatement statement) throws SQLException {
